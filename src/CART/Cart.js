...
import { FaShoppingCart,FaHeart,FaAngleRight,FaSearch} from 'react-icons/fa';
import './Card.css';
import './Cart.css';
    ...
    <nav>
       ...
       <div className="logo">
        ...
        <div className="Rheading">
          <ul className="rhead">
          <li className='rheadi'> <Link to="/">Home</Link></li> 
          <li className='rheadi'> <Link to="/login">Login</Link></li> 
            ...
            <li className='shopin'><Link to="/cart"><FaShoppingCart  /> <span className="cart-lenght">
